...
function buynow() {
    if (selection >= 1) {
        if (selection == 1) {
            window.open('https://agentgaming.gg/checkout/combo/shirts/size/S');
        }
        if (selection == 2) {
            window.open('https://agentgaming.gg/checkout/combo/shirts/size/M');
        }
        if (selection == 3) {
            window.open('https://agentgaming.gg/checkout/combo/shirts/size/L');
        }
        if (selection == 4) {
            window.open('https://agentgaming.gg/checkout/combo/shirts/size/XL');
        }
        if (selection == 5) {
            window.open('https://agentgaming.gg/checkout/combo/shirts/size/XXL');
        }
    } else {
