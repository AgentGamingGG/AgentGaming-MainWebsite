...
function buynow() {
    if (selection >= 1) {
        if (selection == 1) {
            window.open('https://agentgaming.gg/checkout/combo/hoodie/size/S');
        }
        if (selection == 2) {
            window.open('https://agentgaming.gg/checkout/combo/hoodie/size/M');
        }
        if (selection == 3) {
            window.open('https://agentgaming.gg/checkout/combo/hoodie/size/L');
        }
        if (selection == 4) {
            window.open('https://agentgaming.gg/checkout/combo/hoodie/size/XL');
        }
        if (selection == 5) {
            window.open('https://agentgaming.gg/checkout/combo/hoodie/size/XXL');
        }
    } else {
